...
import { Plus, Settings, Moon, Sun, MessageSquare, FileText } from "lucide-react";
import McpPanel from "./components/mcp/McpPanel";
import ConversationPanel from "./components/conversation/ConversationPanel";
import GlobalRulesPanel from "./components/rules/GlobalRulesPanel";
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            ...
            <button
              ...
              className="inline-flex items-center gap-2 px-4 py-2 text-sm font-medium rounded-lg transition-colors bg-purple-500 text-white hover:bg-purple-600 dark:bg-purple-600 dark:hover:bg-purple-700"
              title="对话记录管理"
            >
            ...
            <button
              ...
              className="inline-flex items-center gap-2 px-4 py-2 text-sm font-medium rounded-lg transition-colors bg-pink-500 text-white hover:bg-pink-600 dark:bg-pink-600 dark:hover:bg-pink-700"
              title="全局规则管理"
            >
              <FileText size={16} />
              全局规则
